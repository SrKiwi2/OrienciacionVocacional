$(function () {
    ...
    fetch("/total-respuestas-si/" + $("#idEstudiante").val())
            ...
            var options_basic = {
                ...
                chart: {
                    ...
                    animations: {
                        ...
                        animateGradually: {
                            enabled: true,
                            delay: 150, // Retraso entre animaciones
                        },
                        dynamicAnimation: {
                            enabled: true,
                            speed: 350, // Velocidad de animación dinámica
                        },
                    },
                },
                colors: ["#615dff"],
                        ...
                        dataLabels: {
                            value: {
                                ...
                                formatter: function (val) {
                                    return val + "%"; // Formatear el valor
                                },
                            },
                        },
                    },
                },
                labels: ["Respuestas SI"],
            };
